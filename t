        ...
        <div class="flex flex-col md:flex-row gap-6">
            ...
            <div class="md:w-2/3 bg-white rounded-xl shadow-sm p-6">
                ...
                <div class="scroll-container">
                    <!-- 自选股表格容器 - 应用浅色滚动条 -->
                    <div id="favoritesContainer" class="overflow-y-auto light-scrollbar max-h-[500px] pr-2">
                    ...
                    <!-- 自选股垂直滚动指示器（浅色） -->
                    <div class="absolute right-0 top-0 h-full w-1 flex items-center">
                        <div class="scroll-indicator h-full w-1">
                            <div id="favoritesScrollHandle" class="scroll-handle h-[100%] w-1"></div>
                        </div>
                    </div>
                </div>
            ...
            <div class="md:w-1/3 bg-white rounded-xl shadow-sm p-6">
                ...
                <div class="scroll-container">
                    <!-- 投资组合容器 - 应用浅色滚动条 -->
                    <div id="portfoliosContainer" class="overflow-y-auto light-scrollbar max-h-[500px] pr-2">
                    ...
                    <div class="absolute right-0 top-0 h-full w-1 flex items-center">
                        <div class="scroll-indicator h-full w-1">
                            <div id="portfoliosScrollHandle" class="scroll-handle h-[100%] w-1"></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <form id="portfolioForm">
                ...
                <div class="mb-6">
                    ...
                    <div id="selectedStocks"
                        class="grid grid-cols-1 sm:grid-cols-2 gap-2 max-h-60 overflow-y-auto light-scrollbar p-2 border border-gray-200 rounded-lg">
